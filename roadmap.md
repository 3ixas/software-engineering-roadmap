# Software Engineering Roadmap (Backend Focus)
...
- Build or refactor a backend service using layered architecture (e.g. controller-service-repo), logging, and error boundaries.
